...
/*
  ...
  ==========================
            ...
            .toSrting()       //  convert number to string 
             100..toString()  
             (100).toString   
  ==========================       
  working with string 
  ==========================
             ...
             - repeat   =>  [stringName].repeat(5)           => name is str variable that i want to repeat 5 times but i dose not affect to the normal value of string 
             - lenght   =>  [stringName].length()            =>  git the length
             - access   =>  
             - search   =>  [stringName].indexOf("l",2)      => search about l - start from index 2      - if  not exist returns -1
                        =>  [stringName].lastIndexOf("l", 5 )  => search about l - start form last index (index of 5 and to to start) - if  not exist returns -1 => no negative values 
