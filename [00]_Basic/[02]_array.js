...
/*
   ...
   ==========================     
           ...
           - unshift(60) => [].unshift()                            => add in start 
           ...
           - include     => [i].include("value", index)              => search for the calue is in array or not if not return -1
...
console.log("this is names with join", names.join(","));
