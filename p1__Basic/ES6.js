...
/*
 ...
 - immutable meaning   => somthing that cannot be changed or added to . => primative type .
...
// => this is good bcz U can pass parameter withn different order it will correctily assigned in the right place 
const profileUpdate = ({ name, age, nationality, location }) => {}; 
profileUpdate({age, nationality ,location , name }); // the age will be assigned into the age 
